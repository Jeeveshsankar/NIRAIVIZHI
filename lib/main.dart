          ...
          child: Column(
            ...
            children: [
              ...
              FadeTransition(
                ...
                child: Text(
                  S.of(context).healthSurveillanceSystem,
  ...
  Widget _buildRecentVisits() {
    ...
    return FutureBuilder<Map<String, dynamic>?>(
      ...
      builder: (context, snapshot) {
        ...
        Widget buildVisitSection(
            String label, List<String> names, Color iconColor) {
          return Column(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    buildVisitSection(
                        'Today', todayNames, const Color(0xFF2196F3)),
                    buildVisitSection(
                        'Yesterday', yesterdayNames, const Color(0xFF4CAF50)),
                    buildVisitSection(
                        '2 Days Ago', twoDaysAgoNames, const Color(0xFF9C27B0)),
                  ],
                ),
              ),
            ),
    ...
    return Center(
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              for (var test in userData?['water_test'] ?? [])
                Padding(
        ...
        child: Column(
          children: [
            ...
            ...patients
                ...
                .toList(),
            if (patients.isEmpty) const Text('No patients available'),
          ],
        ),
      ),
    );
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton.icon(
                                  ...
                                  icon: const Icon(
                                      ...
                                      size: 18),
                                  label: Text(_isWaterSensorConnected
                                      ? 'Reconnect HydroBot'
                                      : 'Connect HydroBot'),
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: const Color(0xFF4CAF50),
                          ...
                          return GridView.count(
                            ...
                            children: [
                              ...
                              _buildSensorCard(
                                  ...
                                  _currentTurbidity > 40
                                      ? Colors.orange
                                      : Colors.green,
                                  Icons.opacity),
                              _buildSensorCard(
                                  'Bacteria',
                                  '$_currentBacteria CFU',
                                  _currentBacteria > 20
                                      ? Colors.red
                                      : Colors.green,
                                  Icons.biotech),
                              _buildSensorCard(
                                  'TDS',
                                  '${(_currentTurbidity * 2.5).toStringAsFixed(0)} ppm',
                                  (_currentTurbidity * 2.5) > 500
                                      ? Colors.orange
                                      : Colors.green,
                                  Icons.water),
                            ],
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          ...
                          label: Text(_isHealthSensorConnected
                              ? 'Refresh Data'
                              : 'Connect Monitor'),
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xFF2196F3),
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: const Text('Test Water Quality'),
          content: const Text(
              'Water testing functionality would be implemented here.'),
          actions: [
            TextButton(
              onPressed: () => Navigator.of(context).pop(),
              child: const Text('Close'),
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    onChanged: (value) =>
                        phValue = double.tryParse(value) ?? 7.0,
                  ),
                  const SizedBox(height: 16),
                  TextFormField(
                    decoration:
                        const InputDecoration(labelText: 'Turbidity (NTU)'),
                    keyboardType: TextInputType.number,
                    initialValue: turbidity.toString(),
                    onChanged: (value) =>
                        turbidity = double.tryParse(value) ?? 10.0,
                  ),
                  const SizedBox(height: 16),
                  TextFormField(
                    decoration: const InputDecoration(
                        labelText: 'Bacteria Count (CFU)'),
                    keyboardType: TextInputType.number,
                    initialValue: bacteriaCount.toString(),
                    onChanged: (value) =>
                        bacteriaCount = int.tryParse(value) ?? 0,
                  ),
                  const SizedBox(height: 16),
                  TextFormField(
                    decoration: const InputDecoration(labelText: 'Notes'),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                      content: Text('Water test recorded successfully')),
                );
              },
              child: const Text('Save'),
            ),
...
class _VillageLeaderDashboardState extends State<VillageLeaderDashboard> {
    ...
    return FutureBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        return GridView.count(
          ...
          mainAxisSpacing: 16,
          children: [
            _buildStatCard('Population', population, Icons.people,
                const Color(0xFFFF9800)),
            _buildStatCard(
                'Households', houseHolds, Icons.home, const Color(0xFF2196F3)),
            _buildStatCard('Water Sources', '6', Icons.water_drop,
                const Color(0xFF4CAF50)),
            _buildStatCard('Health Workers', '$ashaWorkersCount',
                Icons.medical_services, const Color(0xFFF44336)),
          ],
        );
      },
    );
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    Chip(
                        label: Text(
                            '${_villageStats['waterSources']} Water Sources')),
                    Chip(
                        label: Text(
                            '${_villageStats['healthWorkers']} Health Workers')),
  ...
  void _showVillageAlertDialog() {
    final Map<String, String> alertTemplates =
        AlertSystem.getAlertTemplates('village_leader');
                ...
                child: Column(
                  ...
                  children: [
                    DropdownButtonFormField<String>(
                      ...
                      decoration:
                          const InputDecoration(labelText: 'Alert Type'),
                    ),
                    const SizedBox(height: 16),
                    TextField(
                      decoration: const InputDecoration(
                  ...
                  onPressed: () async {
                    ...
                    try {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                            content: Text(
                                'Alert sent to community via $selectedChannel')),
                      );
                    } catch (e) {
                      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget _buildDistrictStats() {
    return Center(
      child: GridView.count(
        ...
        mainAxisSpacing: 16,
        children: [
          _buildStatCard('Villages', '${_districtStats['villages']}',
              Icons.location_city, const Color(0xFF9C27B0)),
          _buildStatCard('Population', '${_districtStats['population']}',
              Icons.people, const Color(0xFF2196F3)),
          _buildStatCard('ASHA Workers', '${_districtStats['ashaWorkers']}',
              Icons.medical_services, const Color(0xFF4CAF50)),
          _buildStatCard('Health Centers', '${_districtStats['healthCenters']}',
              Icons.local_hospital, const Color(0xFFF44336)),
        ],
      ),
    );
  }
                ...
                return Padding(
                  ...
                  child: ListTile(
                    ...
                    leading: Icon(
                      Icons.warning,
                      color:
                          alert['risk'] == 'High' ? Colors.red : Colors.orange,
                    ),
                    title: Text(
                ...
                child: Column(
                  children: [
                    const Icon(Icons.inventory,
                        size: 50, color: Color(0xFF9C27B0)),
                    const SizedBox(height: 16),
                    Text(
                      'Resource Allocation',
                      style: GoogleFonts.poppins(
      ...
      children: _diseaseTrends.entries.map((entry) {
        ...
        return ListTile(
          ...
          title: Text(disease,
              style: GoogleFonts.poppins(fontWeight: FontWeight.bold)),
          subtitle:
              Text('Recent cases: $latest • Series: ${series.join(', ')}'),
                ...
                child: Column(
                  children: [
                    const Icon(Icons.notifications_active,
                        size: 50, color: Color(0xFFF44336)),
                    const SizedBox(height: 16),
                    Text(
                      'Emergency Alerts',
                      style: GoogleFonts.poppins(
...
class FancyOPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.addArc(
        Rect.fromCircle(center: center, radius: radius), 0, 2 * math.pi * 0.95);
